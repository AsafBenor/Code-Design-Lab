		...
		for(int k=0;k<9;k++) {
			...
			if(qs1[i]!=qs[i]-1)
			 ...
			 b.put(t);
		        ...
		        // Adjusted Expectation: After putting the tile back, the quantity should be the same as initially
